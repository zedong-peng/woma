...
Codex owns `home/codex/skills/.system` as mutable per-Environment runtime state. It is not a Package Skill and is excluded from Package Store entries, ownership metadata, locks, and bundles.
