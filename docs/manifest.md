...
| --- | --- | --- | --- | --- |
| Skill | `home/codex/skills/<name>` link through `view/codex/skills/<name>` | `view/claude/skills/<name>` symlink | `view/pi/skills/<name>` symlink | `view/qoder/skills/<name>` symlink |
