...
Woma separates reusable Agent capabilities from repository knowledge.
...
| Shared and Package-specific Memory | Project-local | `<project>/.woma/memory/` |
| Machine-specific Memory | Project-local, uncommitted | `<project>/.woma/local/` |
