...
- Added direct Git subdirectory installation with requested-ref, immutable full-commit, and content-integrity provenance preserved through sync, `harness list`, and portable bundles.
