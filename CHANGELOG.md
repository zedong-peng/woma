...
- Preserved existing Codex and Claude sessions and other opaque user state by adopting missing entries from the original Agent homes once when stable `base` homes are initialized.
