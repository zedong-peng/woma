...
- Proposed reproducible single-Agent Environments containing one version-locked Agent Runtime Package and an Agent-independent capability Package closure; benchmark orchestration remains outside Woma's platform boundary.
