...
const environmentSelection = [
  ...
  '  export QODER_CONFIG_DIR="$HARNESS_ORIGINAL_QODER_CONFIG_DIR"',
  "}",
  "",
  "__harness_apply_env() {",
  "  local active home",
...
function zshHook(): string {
  return [
    ...
    '  export HARNESS_ORIGINAL_QODER_CONFIG_DIR="${HARNESS_ORIGINAL_QODER_CONFIG_DIR:-${QODER_CONFIG_DIR:-$HOME/.qoder}}"',
